"""SQLAlchemy ORM models for cards, downloads, and ratings."""
...
from map_cards.database import Base

__all__ = ["Card", "Download", "Rating"]
...
class Download(Base):
    """Records individual card download events for analytics."""
...
class Rating(Base):
    """User star-rating for a card (one rating per user per card)."""
